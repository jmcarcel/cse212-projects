...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        else
        {
            ...
            _tail.Next = newNode; // Connect previous tail forward to the new node
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If removing at head or tail, use existing helpers.
                if (curr == _head)
                {
                    RemoveHead();
                }
                ...
                {
                    curr.Prev!.Next = curr.Next; // Bridge previous node to next node
                    curr.Next!.Prev = curr.Prev; // Bridge next node back to previous node
                }
